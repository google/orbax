...
class ColocatedPythonDispatcher(Dispatcher):
  ...
  def _colocated_cpu_sharding(
    ...
    target_memory_kind = sharding.memory_kind
    if target_memory_kind == 'device':
      target_memory_kind = 'pinned_host'
