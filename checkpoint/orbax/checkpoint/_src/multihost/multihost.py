...
def initialize_distributed_to_device_ids():
  ...
  client.wait_at_barrier(
      'orbax_global_discovery_device_ids', timeout_in_ms=5000
  )
  ...
  for key, device_ids in ids:
    ...
    # TODO(cpgaffney): Convert str to List[int].
    # This code is currently probably wrong.
    results[distributed_id] = [int(device_id) for device_id in device_ids]
