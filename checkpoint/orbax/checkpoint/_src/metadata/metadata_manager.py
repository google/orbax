...
class MetadataManager:
  ...
  def __init__(
      ...
      *,
      ...
      array_metadata_store: Optional[array_metadata_store_lib.Store] = None,
    ...
    Args:
      primary_host: The process index of the primary host.
      pytree_metadata_options: `PyTreeMetadataOptions` to manage metadata.
      array_metadata_store: Optional `Store` instance for ArrayMetadata.
  ...
  @property
  def primary_host(self) -> int | None:
    return self._primary_host

  @property
  def pytree_metadata_options(self) -> tree_metadata.PyTreeMetadataOptions:
    return self._pytree_metadata_options

  @property
  def array_metadata_store(self) -> Optional[array_metadata_store_lib.Store]:
    return self._array_metadata_store

  @property
  def array_metadata_validator(self) -> array_metadata_store_lib.Validator:
    return self._array_metadata_validator
  ...
  @property
  def enable_post_merge_validation(self) -> bool:
    return self._enable_post_merge_validation
  ...
  async def read_metadata_file(
      ...
      directory: epath.Path,
      *,
      pytree_metadata_options: Optional[
    ...
    options = (
        ...
        if pytree_metadata_options is not None
        else self._pytree_metadata_options
    )
    logging.vlog(
        1,
    ...
    metadata = tree_metadata.InternalTreeMetadata.from_json(
        ...
        pytree_metadata_options=options,
    )
  ...
  async def finalize_async(
    ...
    if self._array_metadata_store is not None:
      ...
      elif multihost.is_primary_host(self._primary_host):
