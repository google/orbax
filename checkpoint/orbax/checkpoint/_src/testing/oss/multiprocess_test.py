...
# /learning/brain/research/jax/tests/multiprocess/multiprocess_test.py.
# Targets should not depend on this library directly. Instead, depend on
# //orbax/checkpoint/_src/testing:multiprocess_test.
# This file is substituted via copybara for OSS checkpoints testing.
