...
_PATHWAYS_SERVER_IMAGE = flags.DEFINE_string(
    ...
    'us-docker.pkg.dev/cloud-tpu-v2-images/pathways-colocated-python/server:2025-12-15',
    'Pathways server image (manages TPU chips).',
)
_PATHWAYS_PROXY_IMAGE = flags.DEFINE_string(
    'pathways_proxy_image',
    'us-docker.pkg.dev/cloud-tpu-v2-images/pathways-colocated-python/proxy_server:2025-12-15',
