...
_MTC_ENABLED = flags.DEFINE_boolean(
    'mtc_enabled',
    False,
    'If True, enable MTC for the workload.',
)
...
def main(argv: Sequence[str]) -> None:
  ...
  if _RAMDISK_DIRECTORY.value and not _MTC_ENABLED.value:
    raise app.UsageError(
        '--mtc_enabled must be True if --ramdisk_directory is provided.'
    )
