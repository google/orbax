...
try:
  ...
  # present.
  import orbax.checkpoint.args as ocp  # pylint:disable=g-import-not-at-top # pytype:disable=import-error

  @ocp.register_with_handler(DatasetIteratorCheckpointHandler, for_save=True)  # pytype:disable=wrong-arg-types
  @dataclasses.dataclass
  class DatasetIteratorCheckpointSave(ocp.CheckpointArgs):
    item: Any

  @ocp.register_with_handler(DatasetIteratorCheckpointHandler, for_restore=True)  # pytype:disable=wrong-arg-types
  @dataclasses.dataclass
  class DatasetIteratorCheckpointRestore(ocp.CheckpointArgs):
    item: Any
