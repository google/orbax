...
class MultiTierCheckpointingInitializationTest(
  ...
  def test_block_and_process_restore_dir_accepts_no_checkpoint_directory_marker(
      self,
  ):
    tmp_dir = self.create_tempdir().full_path
    root = epath.Path(tmp_dir)
  ...
  def test_initialize_mtc_colocated_marks_sidecar_runtime(
    ...
    topology.peer_ranks_by_worker_rank = ((2,), (3,), (0,), (1,))
    ...
    mock_topology_from_devices.assert_called_once_with(("tpu0",), num_slices=2)
