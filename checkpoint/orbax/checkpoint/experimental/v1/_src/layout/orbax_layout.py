...
# TODO(b/455640951): Remove reference to V0 once we refactor core logic to
# handle varying checkpoint formats.
_V0_ERROR_MESSAGE = (
...
class OrbaxLayout(CheckpointLayout):
  ...
  async def metadata(
    ...
    checkpoint_metadata = await read_checkpoint_metadata(
        path
    )
