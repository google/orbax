...
class Checkpointer(epy.ContextManager):
  ...
  def latest(self) -> CheckpointMetadata[None] | None:
    """Returns the latest `CheckpointInfo`, or None if no checkpoints exist.

    See `checkpoints` documentation below.

    Returns:
      The latest checkpoint `CheckpointInfo`, or None if no checkpoints exist.
    """
  ...
  def checkpoints(self) -> Sequence[CheckpointMetadata[None]]:
    """Returns a list of `CheckpointInfo`, sorted ascending by step.
  ...
  def should_save(self, step: int | CheckpointMetadata) -> bool:
  ...
  def save_pytree(
    ...
    Args:
      step: The step number or `CheckpointInfo` to save.
  ...
  def load_pytree(
    ...
    Args:
      step: The step number or `CheckpointInfo` to load.
