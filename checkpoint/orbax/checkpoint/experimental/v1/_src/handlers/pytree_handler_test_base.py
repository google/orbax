...
class PyTreeHandlerTestBase:
  ...
  class Test(parameterized.TestCase):
    ...
    def test_custom_leaf_handler(self, use_zarr3: bool, use_ocdbt: bool):
      ...
      class PointLeafHandler(
          serialization_types.LeafHandler[Point, AbstractPoint]
      ):
        ...
        async def serialize(
          ...
          return asyncio.to_thread(_serialize_impl)

        async def deserialize(
            self,
            params: Sequence[
                serialization_types.DeserializationParam[AbstractPoint]
            ],
