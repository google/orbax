  ...
  class Test(parameterized.TestCase):
    ...
    @parameterized.named_parameters(
        dict(
            ...
            sleep_secs={0: 10, 1: 10},
            expected_msg_primary=(
                r'ChainedFuture completed \d+/\d+ futures but timed out'
            ),
        ...
        dict(
            ...
            expected_msg_non_primary=(
                r'Timeout waiting at barrier .*_commit_complete'
            ),
        ),
        dict(
    ...
    def test_async_save_overall_timeout(
      ...
      check_elapsed_time = check_elapsed_time_primary if is_primary else True
