...
def save_tf_functions(
    supplementals: dict[str, obm.GlobalSupplemental],
    model_dir: str,
  ...
  Args:
    supplementals: The dictionary of global supplementals. The TF supplemental
  ...
  supplementals[TF_SAVED_MODEL_SUPPLEMENTAL_NAME] = obm.GlobalSupplemental(
