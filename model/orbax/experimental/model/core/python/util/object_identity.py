...
if sys.version_info.major == 3 and sys.version_info.minor >= 10:
  ...
  from collections import MutableMapping, MutableSet  # pylint: disable=deprecated-class, g-multiple-import
# pylint: enable=g-import-not-at-top, g-bad-import-order, g-importing-member
...
class ObjectIdentityDictionary(MutableMapping):
...
class ObjectIdentitySet(MutableSet):
  ...
  def discard(self, value):
    self._storage.discard(self._wrap_key(value))

  def add(self, value):
    self._storage.add(self._wrap_key(value))
