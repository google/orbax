...
class DeviceAssignment:
  ...
  id: int
  # TODO(b/424623547): Maybe make coords required. Or if not required,
  # see how JSV would set the number of devices.
  coords: Sequence[int] | None = None
  core_on_chip: int | None = None

# TODO(b/424623547): Add a test for this function.
